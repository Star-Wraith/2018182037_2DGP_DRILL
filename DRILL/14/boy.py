...
class Boy:
    ...
    def get_bb(self):
        return self.x - 50 - server.background.window_left, self.y - 50 - server.background.window_bottom, self.x + 50 - server.background.window_left, self.y + 50 - server.background.window_bottom
    ...
    def handle_collision(self, other, group):
        if group == 'boy:ball':
            self.ball_point += 1
            print(f' 먹은 ball의 갯수{self.ball_point}')
        pass
