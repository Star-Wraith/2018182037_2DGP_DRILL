...
class FixedBackground:
    ...
    def __init__(self):
        ...
        self.window_before_left = self.window_left
        self.window_before_bottom = self.window_bottom
    ...
    def windowcost_x(self):

        return self.window_before_left - self.window_left
    def windowcost_y(self):
        return  self.window_before_bottom - self.window_bottom
